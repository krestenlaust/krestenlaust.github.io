...
export class taskmanager {
    /* Public methods */
    static start_application(appname) {
        // @ts-ignore
        $.get(`applications/${appname}/${appname}.html`, function (data) {
            let pid = taskmanager.generate_pid();
    ...
    static interpret_onload(pid, element) {
...
/* Public variables */
taskmanager.running_applications = [];
taskmanager.window_hierarchy = [];
