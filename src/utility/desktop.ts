...
let doubleClickPending: boolean = false;

let Desktop = function () {

    let iconArray = [];

    function generateShortcut(icon_href: string, icon_text: string, icon_launch: string, index: number) {
    ...
    function emptyIcon(index: number) {
...
async function transferDataToFile(file: File){
